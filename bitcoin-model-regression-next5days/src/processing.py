...
from config import RATIOS, BUFFER, SEQ_LENGTH, PRED_LENGTH, BATCH_SIZE,NAME, START, END
...
def chronological_split(data, ratios=(0.7, 0.15, 0.15), buffer=BUFFER):
    """
...
def moving_avg_normalization(data, window_size=30):
